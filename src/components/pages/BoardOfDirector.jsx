    ...
    <section className="sec-pd bg-accent">
      ...
      <div className="container">
        <div className="row mb-5">
          <h2 className="display-5 mb-4 board-title">Former Board Of Director</h2>
          {boardOfDirector.map((item) => (
            <div className="col-md-3 col-6 row-eq-height mob-mb-5">
              <div className="trending-product-box bg-white shadow border pd-30-15 rounded position-relative text-center mb-3">
      ...
      <div className="container">
        <div className="row mb-5">
          <h2 className="display-5 mb-4 board-title">Current Board Of Director</h2>
          {boardOfDirector.map((item) => (
            <div className="col-md-3 col-6 row-eq-height mob-mb-5">
              <div className="trending-product-box bg-white shadow border pd-30-15 rounded position-relative text-center mb-3">
                <img src={`${IMAGE_URL}/${item.image}`} width="200" height="200" alt="icon" className="mx-auto d-block" />
